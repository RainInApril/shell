...
find . -name "*.gif" -type f | rev | cut -d "." -f 1 | rev | sort -du script that lists all the files with a .gif extension in the current directory and all its sub-directories.
Hidden files should be listed
